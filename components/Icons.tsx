...
export const PhotoShieldIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21.07,10.36,12,3,2.93,10.36A2.29,2.29,0,0,0,2,12.2V17a2,2,0,0,0,2,2H20a2,2,0,0,0,2-2V12.2A2.29,2.29,0,0,0,21.07,10.36Z"  fill="#e0f2fe"/>
        <polyline points="22 17 22 12.2 12 3 2 12.2 2 17" />
        <line x1="2" y1="19" x2="22" y2="19" />
        <path d="M12,14.5a2.5,2.5,0,1,0-2.5-2.5A2.5,2.5,0,0,0,12,14.5Z" fill="#3b82f6" />
        <path d="M16.5,9.5h-9a1,1,0,0,0-1,1v8a1,1,0,0,0,1,1h9a1,1,0,0,0,1-1v-8A1,1,0,0,0,16.5,9.5Z" fill="#e0f2fe"/>
        <rect x="6.5" y="9.5" width="11" height="10" rx="1" ry="1"/>
